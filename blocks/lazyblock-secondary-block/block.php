...
<div class="secondary-block-component container-fluid overflow-hidden">
	<div class="container">
	  	<div class="row d-flex justify-content-between">
	  	  	<div class="secondary-block-title col-lg-6 col-sm-12 col-12 d-flex align-items-center justify-content-center">
	  	  	  	<p><?php echo $attributes["title"]?></p>
	  	  	</div>
	  	  	<div class="secondary-block-text-container d-flex justify-content-center flex-column col-lg-6 col-sm-12 col-12">
