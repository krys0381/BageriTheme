		                ...
		                <div class="some-links-container col-3 p-0 d-none d-xl-flex align-items-top justify-content-center">
		                    <div class="footer-text-container">
								...
								<div class="some-links d-flex">
									<a href="#">
										<div class="some-link"><img src="<?php echo get_template_directory_uri(); ?>/images/facebook.svg" alt=""></div>
									</a>
									<a href="#">
										<div class="some-link"><img src="<?php echo get_template_directory_uri(); ?>/images/instagram.svg" alt=""></div>
									</a>
								</div>
